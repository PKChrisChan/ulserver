...
public class PlayerRecordRequest implements InternalServerMessage{
    ...
    public boolean byName() { return playerId == -1 && playerName.length() > 0; }
    public boolean byId() { return playerId != -1; }
    ...
    public boolean withArts() { return withArts; }
    public boolean withItems() { return withItems; }
